...
function showIssue() {
  output.innerHTML = `
        <h4>Issue Section</h4>
        <p>Today's Date: <b>${today.getDate()}/${today.getMonth()+1}/${today.getFullYear()}</b></p>
      `;
}
...
function showReturn() {
  output.innerHTML = `
        ...
        <p>Please return your books on <b>${today.getDate() + 7}/${today.getMonth()+1}/${today.getFullYear()}</b></p>
      `;
}
