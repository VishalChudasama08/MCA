        ...
        <div class="login-container">
            <div class="login-card">
                <div class="login-header">
                    ...
                    @if (session('registerOkay'))
                        <div style="color: green"> {{ session('registerOkay') }} </div>
                    @endif
                </div>

                <form class="login-form" method="post" action="{{ url('loginNow') }}">
                    @csrf
            ...
            <p style="text-align: center; margin-top: 1.5rem; font-size: 0.8125rem; color: var(--text-secondary);">
                &copy; 2026 DayNight Admin. Designed by <a href="https://www.templatemo.com" target="_blank"
                    rel="nofollow" style="color: var(--accent);">TemplateMo</a>
            </p>
        </div>
    </div>
@endsection
